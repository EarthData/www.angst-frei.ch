...
def process_year(year)
  ...
  File.new("data_bag_processed/death_#{year}.csv", 'w')
  open("data_bag_processed/death_#{year}.csv", 'w') do |f|
    f.puts header
  ...
  File.new("data_bag_processed/death_#{year}_young.csv", 'w')
  ...
  File.new("data_bag_processed/death_#{year}_old.csv", 'w')
  ...
  if !File.file?("data_bag_processed/death_all_old.csv")
    File.new("data_bag_processed/death_all_old.csv", 'w')
  end
  open("data_bag_processed/death_all_old.csv", 'a') do |f|
  ...
  if !File.file?("data_bag_processed/death_all_young.csv")
    File.new("data_bag_processed/death_all_young.csv", 'w')
  end
